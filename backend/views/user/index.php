...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-uppercase mb-0">Gestão de Utilizadores</h5>
                </div>
                        ...
                        <?php foreach ($users as $user): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?= Html::a('<i class="btn btn-outline-info btn-circle btn-lg btn-circle"><i class="fa fa-edit"></i></i>', ['user/update', 'id' => $user->id], ['class' => 'settings','title'=>'Editar utilizador', 'data-toggle'=>'tooltip']); ?>
                                    <?= Html::a('<i class="btn btn-outline-info btn-circle btn-lg btn-circle"><i class="fa fa-trash"></i></i>', ['user/delete', 'id' => $user->id], ['class' => 'delete','title'=>'Apagar','data' => ['method' => 'post'], 'data-toggle'=>'tooltip']); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
